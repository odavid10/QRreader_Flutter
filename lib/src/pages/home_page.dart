...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionBottonLocation: FloatingActionBottonLocation.centerDocked,
      floatingActionBotton: FloatingActionBotton(
  ...
  _scanQR(BuildContext context) async {
    ...
    if(futureString != null){
      ...
      if(Platform.isIOS){
        Future.delayed(Duration(miliseconds: 750), (){
